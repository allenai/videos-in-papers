        ...
        <BrowserRouter>
            <Route path="/">
                <div className="startmenu__container">
                    ...
                    {submitting ? <div className="lds-ring"><div></div><div></div><div></div><div></div></div> : ""}
                    {videoProcessed == -1 ? "Error processing video..." : (videoProcessed == 1 ? "Video processing finished!" : "")} 
                    <br/>
                    {paperProcessed == -1 ? "Error processing paper..." : (paperProcessed == 1 ? "Paper processing finished!" : "")}
                    {finished ? 
                        <div className="startmenu__row">
                            Move to annotating: 
                            <a href={'https://'+window.location.hostname+'/author/'+doi}>{'https://'+window.location.hostname+'/author/'+doi}</a>
                        </div> 
                    : ""}
                </div>
            </Route>
